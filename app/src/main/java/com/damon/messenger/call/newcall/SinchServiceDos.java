...
public class SinchServiceDos extends Service {
    ...
    */
    ...
    static final String TAG = SinchServiceDos.class.getSimpleName();
    ...
    private void start(String userName) {
        ...
        try {
            ...
            &&
                    getApplicationContext().checkCallingOrSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public boolean isStarted() {
            return SinchServiceDos.this.isStarted();
        }

        public void retryStartAfterPermissionGranted() { SinchServiceDos.this.attemptAutoStart(); }
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            System.out.println("DETALLES SINCHALL"+call.getDetails());
            Log.d(TAG, "Incoming call");
                Intent intent = new Intent(SinchServiceDos.this, IncomingCallScreenVideoActivity.class);
                intent.putExtra(CALL_ID, call.getCallId());
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                SinchServiceDos.this.startActivity(intent);
        }
    }
